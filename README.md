...
| `scripts/content-audit.ts`             | Content depth and intent map per page (`npm run audit:content`), feeding `deliverables/seo-content-audit.csv`          |
| `deliverables/PMG-seo-content-plan.md` | The content phase plan: findings, priorities, page template, PMG interviews                                            |
