...
export function Differentiators({ home }: { home: HomeContent }) {
  return (
    <section className="container-shell">
      <div className="rounded-[26px] bg-[radial-gradient(ellipse_at_top_left,#f5efe0,transparent_55%),radial-gradient(ellipse_at_bottom_right,#dfedf6,transparent_55%)] bg-mist px-6 py-14 md:px-10">
        ...
        <div className="grid gap-6 lg:grid-cols-[.9fr_1.1fr]">
          <article className="card flex flex-col">
            ...
            <p className="my-5 text-sm text-muted">
              Our model is built around one idea: responsible pain care that
              lasts.
            </p>
            <ul className="mt-auto divide-y divide-line">
              {[
                ...
                "Financially sustainable for hospitals",
              ].map((line, i) => (
...
export function PartnershipSteps({ home }: { home: HomeContent }) {
  return (
