...
// offset from the grid and overlapping section edges, duotone concept photographs.
// Copy is the existing Home and Partnership copy, unchanged. Motion is CSS only: figures
// count up, the hero photograph drifts, timeline steps slide in (globals.css).
